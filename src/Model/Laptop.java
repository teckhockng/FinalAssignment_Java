...
public class Laptop extends Electronics{
    ...
    public Laptop(double screenSize, double memory, String productName, String productType, String description, String manufacturer, double price) {
        super(productName,productType, description, manufacturer, price);
